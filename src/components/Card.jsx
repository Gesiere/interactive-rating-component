...
const Card = () => {
  ...
  return (
    ...
    <div className="card-top">
      ...
      />
      <h2>
            {isDiscount ? `${prices[rangeValue - 1] - (prices[rangeValue -1] * 0.25)}.00` : `${prices[rangeValue - 1]}.00`} <span>/ month</span>
      </h2>
    </div>
    <div className="card-midsection">
        <small>Monthly Billing</small>
        <input type="checkbox" className='checkbox' 
        checked={isDiscount}  name="discount" id="discount" 
    ...
    <div className='card-bottom'>
        <ul>
            <li> <img src={checkIcon} alt="list"/> <span>Unlimited Websites</span> </li>
            <li> <img src={checkIcon} alt="list"/> <span>100% data ownership</span> </li>
            <li> <img src={checkIcon} alt="list"/> <span>Email reports</span> </li>
        </ul>
